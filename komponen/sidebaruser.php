...
<body>
    ...
    <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-[calc(100vh-2rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5">
        ...
        <nav class="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
            ...
            <!-- aboutUs Sidebar -->
            <div role="button" tabindex="0" class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all <?php echo ($currentPage === 'aboutUs') ? 'bg-gray-300' : 'hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80'; ?> hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                <div class="grid place-items-center mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="h-5 w-5">
                ...
                <a href="../user/aboutususer.php">About Us</a>
            </div>
            ...
            <div role="button" tabindex="0" class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all <?php echo ($currentPage === 'rules') ? 'bg-gray-300' : 'hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80'; ?> hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                ...
                <a href="../user/rulesuser.php">Rules</a>
            </div>
            ...
            <div role="button" tabindex="0" class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all <?php echo ($currentPage === 'rules') ? 'bg-gray-300' : 'hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80'; ?> hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                ...
                <a href="../user/rulesuser.php">History</a>
            </div>
